...
public class CustomizePepperoniActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Defines the layout for CustomizePepperoniActivity's user interface
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customize_pepperoni);
        ...
        spinner = findViewById(R.id.spinnerToppingsPepperoni);
    ...
    */
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            case R.id.spinnerToppingsPepperoni: {
